    ...
    <div class="form_container">
        <div class="wrap_form">
            <div class="container_heading">
                <h2 class="head_copy">Bentornato</h2>
                <p class="body_copy" v-if="false">Registrati per iniziare ad usare Control.</p>
            </div>
            <form @submit.prevent>
                <div class="wrap_field" @focusin="setFocus('email')" @focusout="validateEmail">
                    <input class="input_field" :class="{ error: isEmailNotValid, success: !isEmailNotValid && userData.email.length >= 1 }"
                ...
                <div class="wrap_field" @focusin="setFocus('password')" @focusout="resetFocus('password')">
                    <input class="input_field" id="passwordField" :type="passwordFieldType" v-model="userData.password" autocomplete="off"
                        required>
                ...
                <div class="wrap_btn">
                    <button class="btn_submit" :class="{ error: !isEmailNotValid }" type="submit"
                        @click="continuaPhase">Continua</button>
                </div>
            </form>
            <div class="container_footer">
                <p class="body_copy">Non hai un account? <router-link to="/register">Registrati</router-link></p>
            </div>
        </div>
    </div>
</template>
